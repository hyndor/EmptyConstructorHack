...
public class AsmClassGenerator {
    ...
    private EmptyConstructorCreator newClassInstanceManipulator0(Class<?> clazz) throws Throwable {
        ...
        synchronized (AsmClassGenerator.class) {
            className = "ru/hyndo/constructorhack/generated/EmptyGeneratedConstructorAccessor" + generatedEmptyConstructorAccessorCount++;
        }
        ...
        cw.visit(52, ACC_PUBLIC + ACC_SUPER, className, null, superClassName,
                new String[]{"ru/hyndo/emptyconstructorhack/EmptyConstructorCreator"});
        ...
        Class<?> aClass = classDefiner.defineClass(classLoader == null ? getClass().getClassLoader() : classLoader, dotClassName, bytes);
